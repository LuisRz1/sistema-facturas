    ...
    public function index(Request $request)
    {
        ...
        $kpis = DB::table('factura as f')
            ...
            ->select([
                ...
                DB::raw('SUM(CASE WHEN f.estado NOT IN ("PAGADA") THEN f.monto_pendiente ELSE 0 END) as total_por_cobrar'),
                ...
                DB::raw('COUNT(CASE WHEN f.estado IN ("PENDIENTE","VENCIDO","PAGO PARCIAL","POR VALIDAR DETRACCION") THEN 1 END) as count_pendientes'),
