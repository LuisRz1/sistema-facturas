                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;align-items:center;gap:4px;justify-content:flex-end;">
                                ...
                                <a href="{{ route('cotizaciones.export-pdf', $cot->id_cotizacion) }}" class="action-btn" title="Exportar PDF" target="_blank">
                                    <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M7 3h7l5 5v12a1 1 0 01-1 1H7a2 2 0 01-2-2V5a2 2 0 012-2z"/><path stroke-linecap="round" stroke-linejoin="round" d="M14 3v6h6"/><path stroke-linecap="round" stroke-linejoin="round" d="M9 13h6M9 17h6"/></svg>
                                </a>
