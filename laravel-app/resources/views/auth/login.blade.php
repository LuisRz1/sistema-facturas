...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .forgot {
            font-size: 12px; color: #c8a010; font-weight: 500;
            text-decoration: none; cursor: pointer; background: none; border: none;
        }
        .forgot:hover { color: var(--gold-deep); text-decoration: underline; }
    ...
    <div class="login-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- Aquí puedes agregar el bloque de errores de Laravel --}}
                {{-- @if($errors->any() && !$errors->has('nombre_usuario') && !$errors->has('clave_usuario'))
                    <div style="background:#fef9e0;border:1px solid #f0d96a;border-radius:10px;padding:12px 14px;font-size:13px;color:#7a6838;margin-bottom:20px;display:flex;align-items:center;gap:8px;">
                        {{ $errors->first() }}
                    </div>
                @endif --}}
                ...
                <form method="POST" action="{{ route('login.post') }}" id="login-form">
                    ...
                    <div class="form-group f1">
                        ...
                        <div style="font-size:12px;color:#c0392b;margin-top:5px;display:flex;align-items:center;gap:5px;">
