...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('cotizaciones.index') }}" class="nav-item {{ request()->routeIs('cotizaciones.*') ? 'active' : '' }}">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
            </svg>
            Valorizaciones
        ...
        <a href="{{ route('catalogos.index') }}" class="nav-item {{ request()->routeIs('catalogos.*') ? 'active' : '' }}">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="nav-label">Conciliacion Bancaria</div>

        <a href="{{ route('conciliacion.dashboard') }}" class="nav-item {{ request()->routeIs('conciliacion.dashboard') ? 'active' : '' }}">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('conciliacion.importar') }}" class="nav-sub-item {{ request()->routeIs('conciliacion.importar*') ? 'active' : '' }}">
            <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/>
            </svg>
            Importar Extracto
        ...
        <a href="{{ route('conciliacion.bandeja') }}" class="nav-sub-item {{ request()->routeIs('conciliacion.bandeja') ? 'active' : '' }}">
            <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('conciliacion.historial') }}" class="nav-sub-item {{ request()->routeIs('conciliacion.historial') ? 'active' : '' }}">
            <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('conciliacion.auditoria') }}" class="nav-sub-item {{ request()->routeIs('conciliacion.auditoria') ? 'active' : '' }}">
            <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('conciliacion.configuracion') }}" class="nav-sub-item {{ request()->routeIs('conciliacion.configuracion*') ? 'active' : '' }}">
            <svg width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('usuarios.index') }}" class="nav-item {{ request()->routeIs('usuarios.*') ? 'active' : '' }}">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 8.646 4 4 0 010-8.646M9 9H3v12a3 3 0 003 3h12a3 3 0 003-3V9h-6m0 0V5a3 3 0 00-3-3H9a3 3 0 00-3 3v4z" />
            </svg>
            Gestión de Usuarios
        </a>
        @endif
